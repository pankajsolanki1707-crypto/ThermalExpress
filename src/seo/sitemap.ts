...
export const SEO_ROUTES: SEORoute[] = [
  ...
  {
    path: '/about-us',
    title: 'About Us | Thermal Express - Zero Signup Retail Counter Billing',
    description: 'Learn about Thermal Express, our mission to support micro-retailers, Kirana stores, and mobile vendors with free, offline-first Web Bluetooth billing software.',
    h1: 'About Thermal Express & Bluetooth Thermal Hardware Specifications',
    keywords: [
      'About Thermal Express',
      'Offline POS Billing Web App Mission',
      'Bluetooth Thermal Printer Setup Specs',
      'Free Retail POS Utility',
    ],
    category: 'home',
    hardwareSupport: 'Both',
  },
  {
    path: '/privacy-policy',
    title: 'Privacy Policy | Thermal Express - 100% Offline & Private POS',
    description: 'Thermal Express Privacy Policy: 100% local browser storage, zero account signup, zero data collection.',
    h1: 'Thermal Express Privacy Policy & Local Storage Commitments',
    keywords: [
      'Thermal Express Privacy Policy',
      'Offline POS Data Privacy',
      'Local Storage Receipt Maker Security',
      'Zero Signup Billing Security',
    ],
    category: 'home',
    hardwareSupport: 'Both',
  },
